...
<li><a class="selected" href="/perl/jadrn013/proj1/deleteInventory.cgi">Delete Inventory</a></li>
...
<div class="successCenter" id ="confirmation" style="text-align:center; colo: #F00; font-size:30px; padding-top:30px;"></div>
...
<ul class="inlineobjects">            
            ...
            <li><select name="category" id="category" disabled></select> </li>
</ul> 
<ul class="inlineobjects"> 
			<li><label class="title">Vendor:<span class="astric">*</span></label></li> 
    		<li><select name="vender" id="vender" disabled></select> </li>
</ul> 
<ul class="inlineobjects"> 
            <li><label class="title">Manufacturer's Identifier:<span class="astric">*</span></label></li> 
            <li><input type="text" name="manufacturersidentifier" id="manufacturersidentifier" size="25" readonly/></li>
</ul> 
<ul class="inlineobjects">           
        	<li><label class="title">Description:<span class="astric">*</span></label></li> 
			<li><textarea rows="4" cols="50" name="description" id="description" readonly></textarea></li>
</ul> 
<ul class="inlineobjects">  
        	<li><label class="title">Product Features:<span class="astric">*</span></label></li> 
            <li><textarea rows="4" cols="50" name="productfeatures" id="productfeatures" readonly></textarea></li>
</ul>
<ul class="inlineobjects">         
            <li><label class="title">Cost:<span class="astric">*</span></label></li> 
          \$\ <li><input type="text" name="cost" id="cost" size="25" readonly/></li>
</ul> 
<ul class="inlineobjects">         
            <li><label class="title">Retail:<span class="astric">*</span></label></li> 
          \$\ <li><input type="text" name="retail" id="retail" size="25" readonly/></li>
</ul> 
<ul class="inlineobjects"> 
            ...
            <li><img id="prodImageView" src="" alt="product image" height="65" width="65"></li>
             <input type="hidden" name="formType" id="formType" value="delete">
</ul>
